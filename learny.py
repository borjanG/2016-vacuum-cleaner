...
if __name__ == "__main__":
    ...
    # Stochy
    a = Aspirateur_KB(.25,[8,2],learn=True)
    nb_cols= 75
    ...
    py.plot(list(range(1, nb_cols)), eval_agent, "Orange", label='Pe = .25')
    ...
    py.plot(list(range(1, nb_cols)), eval_agent, "Black", label='Stochy')
    # py.legend(loc='lower right')
    py.xlabel("Taille du monde (nombre de colonnes)")
    py.ylabel("Performance")

    # #learny
    a = Aspirateur_KB(.5,[8,2],learn=True)
    # nb_cols= 40
    mondes = [World(a, 1, i) for i in range(1, nb_cols)]
    eval_monde = list()
    eval_agent=list()
    for monde in mondes:
        ...
        eval_agent.append(dico['Evaluation Agent'])
    # py.plot(list(range(1, nb_cols)), eval_monde, "Purple", label='Performance Globale')
    py.plot(list(range(1, nb_cols)), eval_agent, "Blue", label='Pe = .5')
    # py.legend(loc='upper right')
    py.xlabel("Taille du monde (nombre de colonnes)")
    py.ylabel("Performance")
    ...
    for monde in mondes:
        ...
        eval_agent.append(dico['Evaluation Agent'])
    # py.plot(list(range(1, nb_cols)), eval_monde, "Purple", label='Performance Globale')
    py.plot(list(range(1, nb_cols)), eval_agent, "green", label='Pe = .75')
    py.legend(loc='lower right')
    py.xlabel("Taille du monde (nombre de colonnes)")
    py.ylabel("Performance")
    # py.title("Aspi v1 learny")
    ...
    a = Aspirateur_KB(0.9,[8,2],learn=True)
    # nb_cols=40
    mondes = [World(a, 1, i) for i in range(1, nb_cols)]
    eval_monde = list()
    eval_agent=list()
    for monde in mondes:
        ...
        eval_agent.append(dico['Evaluation Agent'])
    # py.plot(list(range(1, nb_cols)), eval_monde, "Purple", label='Performance Globale')
    py.plot(list(range(1, nb_cols)), eval_agent, "red", label='Pe = .9')
    py.legend(loc='lower right')
    py.xlabel("Taille du monde (nombre de colonnes)")
    py.ylabel("Performance")
    # py.title("Aspi v1 learny")

    a = Aspirateur_KB(0.985,[8,2],learn=True)
    # nb_cols=40
    mondes = [World(a, 1, i) for i in range(1, nb_cols)]
    eval_monde = list()
    eval_agent=list()
    for monde in mondes:
        ...
        eval_agent.append(dico['Evaluation Agent'])
    # py.plot(list(range(1, nb_cols)), eval_monde, "Purple", label='Performance Globale')
    py.plot(list(range(1, nb_cols)), eval_agent, "brown", label='Pe = .985')
    py.legend(loc='lower right')
    py.xlabel("Taille du monde (nombre de colonnes)")
    py.ylabel("Performance")
    py.title("Aspi v1 learny")
